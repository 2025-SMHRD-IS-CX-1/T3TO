...
3. **분량**: 각 버전당 공백 포함 **1000자~1200자 사이**로 작성하십시오. 800자 이상으로 충분히 상세하게 서술하여 사용자가 요청한 분량(700~800자)을 확실히 충족하도록 하십시오.
4. **구조**: 전체 글을 **4~5개의 핵심 문단**으로 구성하십시오. 각 문단이 구체적인 에피소드와 역량을 충분히 포함하도록 하십시오.
