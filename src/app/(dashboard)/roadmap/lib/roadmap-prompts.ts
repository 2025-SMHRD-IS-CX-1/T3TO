...
- 전기/전자 직무: 전기기사, 전자기사, 전기공사기사, 전기산업기사, 산업계측제어기술사, 전기안전기술사 등
- 기계/자동차 직무: 기계설계기사, 일반기계기사, 자동차정비기사, 메카트로닉스기사, 용접기사 등
- 토목/건설/건축 직무: 토목기사, 건축기사, 건설안전기사, 측량및지형공간정보기사, 콘크리트기사 등
- 화학/환경 직무: 화학분석기사, 환경기사, 대기환경기사, 수질환경기사, 위험물산업기사 등
- IT/개발 직무: 정보처리기사, SQLD, ADsP, 정보보안기사, 빅데이터분석기사, 컴퓨터활용능력 등
- 의료/헬스케어: 의료기기산업기사, 임상심리사, 사회복지사 등
- 데이터/AI: ADsP, SQLD, 빅데이터분석기사, 정보처리기사 등
- 경영/사무: 경영지도사, 사회조사분석사, 유통관리사, 전산회계, 세무사 등
- **분야 혼동 금지**: 전기전자 직무에 ADsP·SQLD 등 IT 자격증 추천 금지. 기계 직무에 전기 자격증 추천 금지. 반드시 해당 직무·전공 분야의 자격증만 선별할 것.
- **학력별 등급 제한 (필수)**:
  * 4년제 대학교 재학·졸업예정·졸업·대학원 이상 → **기사 등급만** 추천. 기능사·산업기사는 4년제 대학생에게 하위 등급이므로 절대 추천하지 말 것.
  * 전문대(2년제) → 산업기사 위주 추천.
  * 고졸 → 기능사 위주 추천.
...
- **학력별 등급 제한**: 4년제 대학교 재학 이상 → 기사 등급만 추천(기능사·산업기사 추천 금지). 전문대 → 산업기사 위주. 고졸 → 기능사 위주.
...
`
    ...
    const educationNote = education_level
        ? `\n- **자격조건**: 내담자 학력 "${education_level}"${work_experience_years > 0 ? `, 직종 경력 ${work_experience_years}년` : ''}에 따라 추천하라. 고졸→기능사(경력 2년↑ 시 산업기사), 전문대→산업기사 위주. **4년제 대학교 재학·졸업예정·졸업 이상→기사 등급만 추천할 것. 기능사·산업기사는 4년제 대학생에게 하위 등급이므로 추천하지 말 것.** 아래 목록은 이미 학력 조건으로 필터된 자격증만 포함한다.`
        : ''
